...
import { Home, Package, Truck, BarChart3, Menu, X, Bell, User, Settings, LogOut, Store, Plus, Trash2, RefreshCw } from "lucide-react"
                ...
                <div className="space-y-2">
                  ...
                  {connectedStores.some(s => s.isValid === false) && (
                    <div className="text-xs text-amber-600 bg-amber-50 dark:bg-amber-900 p-2 rounded border border-amber-200 dark:border-amber-700">
                      ...
                      <Link href="/connect-shopify" className="underline hover:no-underline">
                        Reconnect them
                      </Link>
                    </div>
                  )}
